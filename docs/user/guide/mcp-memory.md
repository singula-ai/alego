...
```sh
alego web --patch "$PWD/apps/cli/config/examples/mcp-memory/memorix.cordis.yml"
```
...
alego web --patch "$PWD/apps/cli/config/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
alego web --patch "$PWD/apps/cli/config/examples/mcp-memory/engram.cordis.yml"
```
