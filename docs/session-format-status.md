...
evidenceTag: alego-v0.1.5-alpha.1
```

Evidence: [published release](https://github.com/singula-ai/alego/releases/tag/alego-v0.1.5-alpha.1) and [its tagged writer source](https://github.com/singula-ai/alego/blob/alego-v0.1.5-alpha.1/packages/core/session/src/types.ts).
