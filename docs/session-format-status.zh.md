...
证据：[已发布产品版本](https://github.com/singula-ai/alego/releases/tag/alego-v0.1.5-alpha.1)及[对应标签的写入器源码](https://github.com/singula-ai/alego/blob/alego-v0.1.5-alpha.1/packages/core/session/src/types.ts)。
