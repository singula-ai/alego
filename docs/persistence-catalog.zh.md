...
'command/done': {
  ...
  kind: 'success' | 'error'
  text?: string
  sourceEventSeq?: import('@singula-ai/alego-session/types').SessionSeq
}
```
...
'session-log-deepseek/delivery-accepted': {
  ...
  sessionId: import('@singula-ai/alego-session/types').SessionId
  ...
  throughSeq: import('@singula-ai/alego-session/types').SessionSeq
}
```
