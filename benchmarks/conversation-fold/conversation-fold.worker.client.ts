...
import { AssistantStreamAccumulator } from '@singula-ai/alego-llm/assistant-stream'
import type { StreamChunk } from '@singula-ai/alego-llm'
import type { SessionEvent } from '@singula-ai/alego-session/types'
import type { ChatSnapshot } from '@singula-ai/alego-client-ui-chat/client'
import type { SessionEventLikeEntry } from '@singula-ai/alego-api-session-controller/client'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@singula-ai/alego-client-store': import.meta.resolve('@singula-ai/alego-client-store'),
  '@singula-ai/alego-llm/assistant-stream': import.meta.resolve('@singula-ai/alego-llm/assistant-stream'),
  '@singula-ai/alego-session/surface': import.meta.resolve('@singula-ai/alego-session/surface'),
  '@singula-ai/alego-token-meter/client': import.meta.resolve('@singula-ai/alego-token-meter/client'),
})
