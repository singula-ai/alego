...
import type { ClientModuleLoaderTarget, WebBootEntry, WebBootGraph } from '@singula-ai/alego-client-modules/client'
...
const BOOTSTRAP_IDS = ['@singula-ai/alego-client-modules'] as const
