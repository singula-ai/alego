...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@alego/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@alego/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@alego/token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@alego/skill-filesystem"}\n',
