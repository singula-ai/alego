/** Immutable version identity shared by one Electron shell and its bundled alego runtime. */
...
export interface DesktopRelease {
  ...
  /** Exact version used by both Electron and `@singula-ai/alego`. */
...
export function parseDesktopRelease(value: unknown): DesktopRelease {
  if (!isRecord(value) || value.schemaVersion !== 1 || typeof value.version !== 'string'
    ...
    throw new Error('alego desktop: invalid desktop release metadata')
  }
  return {
    schemaVersion: 1,
