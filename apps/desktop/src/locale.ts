...
export const en = {
  ...
  startupFailed: 'Alego could not start',
  startupLoading: 'Starting Alego…',
  ...
  updateTitle: 'Alego Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Alego {version}\n\nThis release includes its matching alego version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'Alego — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'Alego 无法启动',
  startupLoading: '正在启动 Alego…',
  ...
  updateTitle: 'Alego 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Alego {version}\n\n新版本绑定匹配的 alego，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'Alego — 桌面插件',
