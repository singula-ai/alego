 ...
 * @throws When the selected deployment lacks a valid HTTPS origin.
 */
 ...
 * @throws When the selected deployment lacks a required origin or bucket, or its origin is not HTTPS.
 */
