 ...
 * `@singula-ai/alego-spill` storage seam. Persists oversized text to a
...
export class LocalSpillStore extends SpillStore {
   ...
   * `alego-spill-*` temp root (see {@link discoverDefaultRoots}), pruned when
  ...
  /**
   * The directory scanned for prior default `alego-spill-*` roots — the OS tmpdir,
