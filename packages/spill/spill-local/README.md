...
Mount this backend in a composition that spills text to the local filesystem. It registers as the `ctx.spillStore` service that the `alego-spill-policy` plugin and other callers use.
