...
import { CallId } from '@singula-ai/alego-llm/brand'
import type {
  AssistantMessage,
  ContentBlock,
  MessageSource,
...
import type { RequestPayload, ResponseValue, RpcMethodMap } from '@singula-ai/alego-host-apiproxy/api'
 ...
 * presenter's shape (see formatGrepOutput in alego-tool-fs-search): a
 ...
 * formatGlobOutput in alego-tool-fs-search).
 */
