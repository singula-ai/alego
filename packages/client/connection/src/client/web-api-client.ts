...
import { hostFrameSchema, muxFrameSchema } from '@singula-ai/alego-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@singula-ai/alego-host-apiproxy/api/rpc.schema'
