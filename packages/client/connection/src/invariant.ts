/**
 * Package-owned invariant companion for `@singula-ai/alego-client-connection`.
 * @module @singula-ai/alego-client-connection/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-connection'
