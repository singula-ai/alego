...
import type { IndexInjection, WebServer, WebRoute, WebUpgradeRoute } from '@singula-ai/alego-host-webserver'
...
describe('connection node half', () => {
  ...
  it('injects validated browser recovery timing and withdraws it on disposal', async () => {
    ...
    try {
      ...
      expect(rows).toEqual([{
        kind: 'global', name: '__ALEGO_CONNECTION_RECOVERY__', value: {
