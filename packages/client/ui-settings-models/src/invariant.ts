/**
 * Package-owned invariant companion for `@alego/client-ui-settings-models`.
 * @module @alego/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-settings-models'
