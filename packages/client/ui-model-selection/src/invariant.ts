/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-model-selection`.
 * @module @singula-ai/alego-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-model-selection'
