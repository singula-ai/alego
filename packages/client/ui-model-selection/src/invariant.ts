/**
 * Package-owned invariant companion for `@alego/client-ui-model-selection`.
 * @module @alego/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-model-selection'
