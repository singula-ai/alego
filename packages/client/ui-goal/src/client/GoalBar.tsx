...
import type { GoalActivation, GoalSnapshot } from '@singula-ai/alego-goal/client'
import {
...
import type { InjectFace, PropsLocale, TranslateNS } from '@singula-ai/alego-client-ui-slots'
...
export type GoalDockProps =
  import('@singula-ai/alego-client-ui-slots').PropsRuntime<'conversation.input.dock'>
