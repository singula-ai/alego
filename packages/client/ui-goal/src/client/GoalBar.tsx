...
import type { GoalSnapshot } from '@singula-ai/alego-goal/client'
import {
...
export type GoalDockProps = import('@singula-ai/alego-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
