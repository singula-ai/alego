...
import type { GoalSnapshot } from '@alego/goal/client'
import {
...
export type GoalDockProps = import('@alego/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
