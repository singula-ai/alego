/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-goal`.
 * @module @singula-ai/alego-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-goal'
