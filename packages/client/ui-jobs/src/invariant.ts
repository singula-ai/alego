/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-jobs`.
 * @module @singula-ai/alego-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-jobs'
