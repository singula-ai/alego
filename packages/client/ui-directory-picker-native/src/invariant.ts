/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-directory-picker-native`.
 * @module @singula-ai/alego-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-directory-picker-native'
