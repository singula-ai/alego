/**
 * Package-owned invariant companion for `@alego/client-ui-directory-picker-native`.
 * @module @alego/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-directory-picker-native'
