 ...
 * `alego-resource://<type>/…` URL: the host names the protocol. The protocol's
 ...
 * encodes it in the path, as `alego-resource://file/session/<sessionId>/<absolute
...
import type { ResourceProtocolMap } from '@singula-ai/alego-client-ui-slots'
...
export interface ResourceProvider<P extends ResourceProtocol> {
   ...
   * @param address - the full address, an `alego-resource://<type>/…` URL.
