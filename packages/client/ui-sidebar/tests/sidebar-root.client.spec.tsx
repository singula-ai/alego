...
describe('SidebarRoot shell', () => {
  ...
  it('renders generic brand fallbacks when no package fills the slots', () => {
    vi.stubEnv('ALEGO_CLIENT_COMMIT_HASH', '0123456')
    vi.stubEnv('ALEGO_CLIENT_GIT_DIRTY', 'true')
    vi.stubEnv('ALEGO_CLIENT_VERSION', '1.2.3-rc.4')
    ...
    expect(screen.getByText('ALEGO Local Build')).toBeTruthy()
    expect(screen.getByText('1.2.3-rc.4-0123456-dirty')).toBeTruthy()
    expect(container.querySelector('svg')).not.toBeNull()
  })

  it.each([
    [{ ALEGO_CLIENT_VERSION: '1.2.3' }, '1.2.3'],
    [{ ALEGO_CLIENT_COMMIT_HASH: 'abcdef0', ALEGO_CLIENT_VERSION: '1.2.3' }, '1.2.3-abcdef0'],
