...
import type { ILayout, MainPanelId } from '@singula-ai/alego-client-ui-layout/client'
import type { PropsRenderSlots, PropsRuntime, SlotLabel } from '@singula-ai/alego-client-ui-slots'
