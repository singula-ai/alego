...
# @singula-ai/alego-client-ui-agent-preset
...
- [alego-agent-presets](../../preset/agent-presets/README.md) — the host roster and composition the surfaces read and manage.
