...
// The resolution itself is the shared fold in `alego-agent-presets/display`,
...
export { presetDisplayText } from '@singula-ai/alego-agent-presets/display'
export type { PresetDisplaySource, PresetDisplayText } from '@singula-ai/alego-agent-presets/display'
