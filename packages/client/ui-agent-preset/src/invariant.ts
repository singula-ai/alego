/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-agent-preset`.
 * @module @singula-ai/alego-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-agent-preset'
