...
import { apply, inject, SETTINGS_NS } from '@singula-ai/alego-client-ui-theme/client'
import type { AppearanceRowInjected, FontSizeRowInjected, ThemeRuntime } from '@singula-ai/alego-client-ui-theme/client'
