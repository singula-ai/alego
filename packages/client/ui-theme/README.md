---
description: "Theme and content-font-size settings for the alego web client: --dsw-* token stylesheets, ThemeRuntime state, General settings rows, and the pre-plugin bootstrap."
...
- [ui-conversation](../ui-conversation/README.md) — a consumer of `--alego-scrollbar-width` for the composer seat.
