/**
 * Package-owned invariant companion for `@alego/client-ui-user-questions`.
 * @module @alego/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-user-questions'
