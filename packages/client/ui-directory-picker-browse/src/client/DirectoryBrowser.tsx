...
import type { DirectoryEntry, DirectoryListing } from '@singula-ai/alego-client-runtime/client'
import { DirectoryBrowseError } from '@singula-ai/alego-client-runtime/client'
