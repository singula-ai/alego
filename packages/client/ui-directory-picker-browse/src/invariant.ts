/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-directory-picker-browse`.
 * @module @singula-ai/alego-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-directory-picker-browse'
