/**
 * Package-owned invariant companion for `@alego/client-ui-directory-picker-browse`.
 * @module @alego/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-directory-picker-browse'
