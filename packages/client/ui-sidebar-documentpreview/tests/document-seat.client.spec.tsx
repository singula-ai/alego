...
import { absoluteFileAddress, sessionFileAddress } from '@singula-ai/alego-util-workspace-path'
import { apply as resourcesApply, inject as resourcesInject } from '@singula-ai/alego-client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@singula-ai/alego-client-ui-sidebar-right/src/client/index.ts'
...
async function boot() {
  ...
  const open = (name: string): void => {
    act(() => { rt.ctx.sidebarRight.openResource('alego-resource://file/session/documents/' + name) })
  }
