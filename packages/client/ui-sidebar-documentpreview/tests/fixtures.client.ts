...
import type { RemoteFailure, RemoteResult } from '@singula-ai/alego-api-remotes/client'
import type { ResourceSnapshot } from '@singula-ai/alego-client-resources/client'
import type { SessionId } from '@singula-ai/alego-session/types'
import type { WorkspaceFileStat, WorkspaceFileText } from '@singula-ai/alego-api-workspace-files/types'
...
import type { TabId } from '@singula-ai/alego-client-ui-dockkit'
...
export const ADDRESS = 'alego-resource://file/session/s-1/work/notes.md'
