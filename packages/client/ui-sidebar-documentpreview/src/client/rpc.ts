 ...
 * session and a workspace path while a tab carries an `alego-resource://file/`
...
import type { WorkspaceFileBytes, WorkspaceFileRange, WorkspaceFileText } from '@singula-ai/alego-api-workspace-files/types'
...
/**
 * The session and path one `alego-resource://file/…` address names.
 *
 ...
 * @param address - a tab's `alego-resource://file/…` address.
