 ...
 *
 * The type claims every `alego-resource://file/session/<sessionId>/<path>`
 ...
 */
import type { SidebarRightTabDefinition } from '@singula-ai/alego-client-ui-sidebar-right/client'
...
export const TEXTPREVIEW_ID = '@singula-ai/alego-client-ui-sidebar-documentpreview'
