...
import type { PropsRuntime, SlotHookFactory } from '@singula-ai/alego-client-ui-slots'
import type { UseSidebarRightTabInfo } from '@singula-ai/alego-client-ui-sidebar-right/client'
