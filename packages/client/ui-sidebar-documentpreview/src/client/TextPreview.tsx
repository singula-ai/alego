...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@singula-ai/alego-client-ui-slots'
import { FileTypeIcon, IconRefreshOutline16, Menu, Tooltip, classifyFileType } from '@singula-ai/alego-client-ui-primitives'
import { pathPartsOf } from '@singula-ai/alego-util-workspace-path'
