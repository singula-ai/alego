/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-renderer`.
 * @module @singula-ai/alego-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-renderer'
