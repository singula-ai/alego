...
import { SlotCore, standardHookPropName } from '@singula-ai/alego-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@singula-ai/alego-client-ui-slots').KeyedStandardSource> = {}
