...
const SNAPSHOT = {
  entries: [
    ...
    { entryId: '8a1b2c3d', moduleName: '@singula-ai/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    { entryId: 'unobserved', moduleName: '@fixture/unobserved-name', enabled: true, fiberPhase: null },
    { entryId: 'bash-host', moduleName: '@singula-ai/alego-tool-bash', enabled: false, fiberPhase: null },
    { entryId: 'fs-host', moduleName: '@singula-ai/alego-tool-fs', enabled: false, fiberPhase: null },
  ...
  agentPresets: [
    {
      ...
      isDefault: true,
      rows: [
        { entryId: 'bash', moduleName: '@singula-ai/alego-tool-bash', enabled: true, fiberPhase: 'active' },
        { entryId: 'fs', moduleName: '@singula-ai/alego-tool-fs', enabled: true, fiberPhase: null },
        {
          entryId: 'pwsh',
    ...
    },
    {
      ...
      isDefault: false,
      rows: [
        { entryId: 'bash', moduleName: '@singula-ai/alego-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'bash-fork', moduleName: '@singula-ai/alego-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'fs', moduleName: '@singula-ai/alego-tool-fs', enabled: 'conditional', fiberPhase: null },
      ],
    },
...
describe('PluginInventorySettingsTab', () => {
  ...
  it('distinguishes collapsed same-module rows by stable entry id', async () => {
    ...
    await renderReady({
      ...
      agentPresets: [{
        ...
        isDefault: true,
        rows: [
          { entryId: 'tool-subagent-primary', moduleName: '@singula-ai/alego-tool-subagent', enabled: true, fiberPhase: null },
          { entryId: longId, moduleName: '@singula-ai/alego-tool-subagent', enabled: false, fiberPhase: null },
        ],
      }],
    })
  ...
  it('renders a rosterless deployment as one expanded global list', async () => {
    const view = await renderReady({
      entries: [
        { entryId: 'hmr', moduleName: '@singula-ai/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
