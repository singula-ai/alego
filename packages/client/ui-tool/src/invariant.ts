/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-tool`.
 * @module @singula-ai/alego-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-tool'
