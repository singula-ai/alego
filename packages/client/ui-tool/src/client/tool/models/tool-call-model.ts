...
import type { ToolCallBlock, ToolResultNode } from '@singula-ai/alego-client-ui-chat/client'
...
export type { ToolCallBlock } from '@singula-ai/alego-client-ui-chat/client'
