 ...
 * ({@link module:@singula-ai/alego-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@singula-ai/alego-client-ui-primitives'
