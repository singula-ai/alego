...
import type { OpenFileOptions, ToolCallBlock } from '@singula-ai/alego-client-ui-chat/client'
import type { MessageImageLoader, MessageImageSource } from '@singula-ai/alego-client-ui-conversation/client'
