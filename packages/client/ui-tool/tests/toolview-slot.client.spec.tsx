...
import { apply as applyTool, inject as injectTool } from '@singula-ai/alego-client-ui-tool/client'
...
describe('keyed toolview hole through the real machinery', () => {
  ...
  it('file-path clicks travel owner openFile → chat inject → the right Sidebar', async () => {
    ...
    await vi.waitFor(() => {
      expect(b.sidebarRight.openResource).toHaveBeenCalledWith('alego-resource://file/session/s1/src/a.ts')
    })
