...
import type { SessionProviderComponent, TranslateNS } from '@singula-ai/alego-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@singula-ai/alego-client-ui-conversation/src/client/contract/slots.ts'
