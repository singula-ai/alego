---
description: "Shared Workspace browser and picker plugin for the alego web client: grouped or flat session rows, add/rename/reorder, search, fork, archive, and the directory-flow picking hole."
