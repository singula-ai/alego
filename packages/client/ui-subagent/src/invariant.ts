/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-subagent`.
 * @module @singula-ai/alego-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-subagent'
