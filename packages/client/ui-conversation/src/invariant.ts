/**
 * Package-owned invariant companion for `@alego/client-ui-conversation`.
 * @module @alego/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-conversation'
