...
import { IconPaperclipOutline16 } from '@singula-ai/alego-client-ui-primitives'
import { createSnapshotStore, type BoundActions } from '@singula-ai/alego-client-store'
