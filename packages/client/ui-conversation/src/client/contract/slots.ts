...
import type { SessionSnapshot } from '@singula-ai/alego-api-session-controller/client'
import type { FileUploadReceiptId } from '@singula-ai/alego-client-file-upload/client'
...
import type { SessionPendingInteraction } from '@singula-ai/alego-client-ui-session/client'
