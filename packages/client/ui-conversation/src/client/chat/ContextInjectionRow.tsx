...
import type { ContextMessageNode } from '@singula-ai/alego-client-runtime/client'
import type { ChatViewSlotProps } from '../contract/slots.ts'
import { DisclosureRow, IconBrowseOutline16 } from '@singula-ai/alego-client-ui-primitives'
