...
describe('decorations', () => {
  ...
  it('claimed token styles the leading leaf and sets the blank-args hint variable', () => {
    ...
    expect(textarea.style.getPropertyValue('--alego-composer-hint')).toBe(JSON.stringify('目标内容'))
    ...
    expect(textarea.style.getPropertyValue('--alego-composer-hint')).toBe('')
  ...
  it('a locale entry for the claimed command overrides the raw claim hint (trailing-space token)', () => {
    ...
    expect(textarea.style.getPropertyValue('--alego-composer-hint')).toBe(JSON.stringify('输入目标，智能体将持续执行'))
  })
