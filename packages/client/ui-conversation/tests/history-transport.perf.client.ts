...
import type { AssistantStreamRecord } from '@singula-ai/alego-llm'
import { SessionSeq } from '@singula-ai/alego-session/types'
import type { SessionEvent, SessionEventMap } from '@singula-ai/alego-session/types'
import type {
  SessionEventEntry,
  SessionHistoryRecord,
  SessionWireEvent,
} from '@singula-ai/alego-api-session-controller/types'
import { historyEntries } from '@singula-ai/alego-api-session-controller/src/client/sessions/history-records.ts'
import type { SessionEventLikeEntry } from '@singula-ai/alego-api-session-controller/client'
import { ConversationNodeAssembler } from '@singula-ai/alego-client-ui-conversation/client'
import type {
