...
import type { CommandContribution, CommandUiContract } from '@singula-ai/alego-client-ui-commands/client'
...
describe('Conversation inject API', () => {
  ...
  it('restores the selected View when a cached Session becomes current', async () => {
    ...
    try {
      ...
      localStorage.setItem(`alego.conversation.${ROOT}`, JSON.stringify({
