...
The localized Hero headline reads “Build AI Agents with ALEGO” in English. Only “ALEGO” uses a static rainbow gradient; forced-colors mode uses readable foreground text.
