...
import type { ClientArtifactBaseline, ClientModuleRegistry, WebBootGraph } from '@singula-ai/alego-client-modules'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'alego-hmr-')) })
