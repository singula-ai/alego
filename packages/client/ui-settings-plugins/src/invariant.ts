/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-settings-plugins`.
 * @module @singula-ai/alego-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-settings-plugins'
