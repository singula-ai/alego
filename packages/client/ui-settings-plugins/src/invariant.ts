/**
 * Package-owned invariant companion for `@alego/client-ui-settings-plugins`.
 * @module @alego/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-settings-plugins'
