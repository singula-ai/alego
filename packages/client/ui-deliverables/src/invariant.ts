/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-deliverables`.
 * @module @singula-ai/alego-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-deliverables'
