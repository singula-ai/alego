/**
 * Package-owned invariant companion for `@alego/client-ui-deliverables`.
 * @module @alego/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-deliverables'
