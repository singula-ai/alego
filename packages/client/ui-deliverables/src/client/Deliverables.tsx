...
import { Button, IconChevronDownOutline14, IconChevronUpOutline14 } from '@singula-ai/alego-client-ui-primitives'
import type { GlobalStandardProps, InjectFace, PropsLocale, SessionStandardProps } from '@singula-ai/alego-client-ui-slots'
