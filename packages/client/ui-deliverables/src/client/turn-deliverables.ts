 ...
 */
import { isAppendSurfaceEvent } from '@singula-ai/alego-session/surface'
import type { TurnTailOwnerProps } from '@singula-ai/alego-client-ui-chat/client'
import type { ConversationNodeDefinition } from '@singula-ai/alego-client-ui-conversation/client'
import type { MarkdownFileMentions } from '@singula-ai/alego-client-ui-primitives'
import type { PresentedFile } from '@singula-ai/alego-tool-present/types'
