...
import { LinkIcon, classifyLinkPath } from '@singula-ai/alego-client-ui-primitives'
import type { HostObservable, InjectFace, PropsLocale } from '@singula-ai/alego-client-ui-slots'
