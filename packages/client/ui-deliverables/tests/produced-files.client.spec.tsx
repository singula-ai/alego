...
import type { ChatFileMentions, TurnTailOwnerProps } from '@singula-ai/alego-client-ui-conversation/client'
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@singula-ai/alego-client-ui-deliverables'])
