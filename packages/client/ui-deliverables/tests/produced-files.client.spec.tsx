...
import type { ChatFileMentions, TurnTailOwnerProps } from '@singula-ai/alego-client-ui-chat/client'
import { makeTranslate, RemoteError, stubSettingsScope } from '@singula-ai/alego-client-test-runtime'
