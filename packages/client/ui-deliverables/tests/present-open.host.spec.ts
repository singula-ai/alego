...
import { WorkspaceFiles } from '@singula-ai/alego-api-workspace-files'
...
import { SessionQueryError } from '@singula-ai/alego-session-query'
import type { SessionEventReadRequest } from '@singula-ai/alego-session-query'
...
async function fixture() {
  const root = await mkdtemp(join(tmpdir(), 'alego-present-open-'))
