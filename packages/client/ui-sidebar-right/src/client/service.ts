 ...
 */
import type { FloatRect, PaneId, TabId, TabRecord } from '@singula-ai/alego-client-ui-dockkit'
import { activeDockPaneId, canSplit, dockPaneIds, findTabPane, getPane } from '@singula-ai/alego-client-ui-dockkit'
...
const RESOURCE_SCHEME = 'alego-resource://'
