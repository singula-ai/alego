...
import { findTabPane } from '@singula-ai/alego-client-ui-dockkit'
import type { TabId } from '@singula-ai/alego-client-ui-dockkit'
import type { KeyedSnapshotSelectorHook, PropsStore, SlotHookFactory } from '@singula-ai/alego-client-ui-slots'
