...
import type { RightbarOwnerProps } from '@singula-ai/alego-client-ui-layout/client'
...
import type { PaneId, TabRecord } from '@singula-ai/alego-client-ui-dockkit'
import type { SlotHookFactory } from '@singula-ai/alego-client-ui-slots'
...
export interface SidebarRightTabActions {
   ...
   * @param address - an `alego-resource://` address.
