 ...
 * (`alego-resource://file/**`, `sidebar://guide`) rather than the URI's path.
 *
...
import type { IconProps } from '@singula-ai/alego-client-ui-primitives'
import { notifySubscribers } from '@singula-ai/alego-client-store'
...
export interface SidebarRightTabDefinition {
   ...
   * (`alego-resource://file/**`); one without is matched against the URI's path at
   * any depth (`*.md` matches `alego-resource://file/session/s1/home/me/notes.md`),
 ...
 * against. `alego-resource://file/session/s1/home/me/b.md` gives `/session/s1/home/me/b.md`;
