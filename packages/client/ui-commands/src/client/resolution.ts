...
const BUILTINS = {
  goal: '@singula-ai/alego-command-goal',
  plan: '@singula-ai/alego-plan-mode',
  feedback: '@singula-ai/alego-command-feedback',
  compact: '@singula-ai/alego-command-compact',
  permission: '@singula-ai/alego-permission-presets',
  export: '@singula-ai/alego-session-log-export',
} as const
