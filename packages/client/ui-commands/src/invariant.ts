/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-commands`.
 * @module @singula-ai/alego-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-commands'
