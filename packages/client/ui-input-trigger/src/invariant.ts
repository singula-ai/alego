/**
 * Package-owned invariant companion for `@alego/client-ui-input-trigger`.
 * @module @alego/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@alego/client-ui-input-trigger'
