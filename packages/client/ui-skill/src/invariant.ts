/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-skill`.
 * @module @singula-ai/alego-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-skill'
