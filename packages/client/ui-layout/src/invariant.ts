/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-layout`.
 * @module @singula-ai/alego-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-layout'
