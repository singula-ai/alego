 ...
 * @module @singula-ai/alego-client-ui-message-feedback/client/dialog
 */
...
import type { FeedbackCategory, FeedbackRecord } from '@singula-ai/alego-command-feedback/types'
