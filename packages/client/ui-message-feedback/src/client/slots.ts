 ...
 * @module @singula-ai/alego-client-ui-message-feedback/client/slots
 */
...
import type { MessageFeedbackItem, MessageFeedbackRating } from '@singula-ai/alego-message-feedback/types'
