/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-message-feedback`.
 * @module @singula-ai/alego-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-message-feedback'
