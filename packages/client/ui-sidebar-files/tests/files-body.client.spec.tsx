...
import { makeTranslate, RemoteError } from '@singula-ai/alego-client-test-runtime'
...
describe('FilesBody', () => {
  ...
  it('a file click opens its session-scoped file: address through the owner; an other entry offers no button', async () => {
    ...
    expect(tabActions.openResource).toHaveBeenCalledWith('alego-resource://file/session/s-test/README.md')
