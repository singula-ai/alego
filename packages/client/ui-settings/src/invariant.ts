/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-settings`.
 * @module @singula-ai/alego-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-settings'
