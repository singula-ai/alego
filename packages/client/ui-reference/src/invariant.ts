/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-reference`.
 * @module @singula-ai/alego-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-reference'
