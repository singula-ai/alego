/**
 * Package-owned invariant companion for `@singula-ai/alego-client-web`.
 * @module @singula-ai/alego-client-web/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-web'
