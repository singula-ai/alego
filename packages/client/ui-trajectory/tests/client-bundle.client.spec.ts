 ...
 * not built (`pnpm --filter @alego/client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@alego/client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@alego/client-runtime/client', await import('@alego/client-runtime/client')],
      ['@alego/client-ui-primitives', await import('@alego/client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@alego/client-locale/client')
