...
import { bindSnapshotSelector, SlotTestRuntime, stubSettingsScope } from '@singula-ai/alego-client-test-runtime'
...
import { EMPTY_CHAT_SNAPSHOT } from '@singula-ai/alego-client-ui-chat/client'
import type {
...
} from '@singula-ai/alego-api-session-controller/client'
import type { WorkspaceSnapshot } from '@singula-ai/alego-api-workspace-controller/client'
...
import { createConversationStore } from '@singula-ai/alego-client-ui-conversation/src/client/stores.ts'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('alego.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`alego.trajectory.duration.${SID}`)).toBeNull()
  })
