...
import { ok, type RemoteMock } from '@singula-ai/alego-remote-mock'
import type { SettingsNamespaceView } from '@singula-ai/alego-settings/types'
import { createClientTest, type TestClient, webApp } from '@singula-ai/alego-client-test-runtime/src/assembly/index.ts'
import { resolveSlotLabel } from '@singula-ai/alego-client-ui-slots'
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@singula-ai/alego-client-locale/src/locale-settings.ts'
...
const SELF = '@singula-ai/alego-client-ui-settings-general'
