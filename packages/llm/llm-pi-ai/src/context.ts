 ...
 *
 * @module alego-llm-pi-ai/context
 */

import { brandString } from '@singula-ai/alego-brand'
import { contentHasImage, LlmError, offloadedImageText, offloadRequestImagesWithPolicy, requestImageHandleText } from '@singula-ai/alego-llm'
import type { ContentBlock, GenerateOptions, ImageAttachmentAccessResolver, Message, ToolCallId } from '@singula-ai/alego-llm'
import type {
  AttachmentId,
  AttachmentStore,
  ImageAttachmentRef,
