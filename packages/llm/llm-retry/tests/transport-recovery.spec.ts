import { createUserMessage, expandAssistantStream } from '@singula-ai/alego-llm'
...
import type { MockLlmBehavior, MockLlmServer } from '@singula-ai/alego-llm-mock-server'
