...
import { AssistantStreamAccumulator, createUserMessage, createSystemMessage, ToolCallId, createMessage } from '@singula-ai/alego-llm'
import type { ContentBlock, Message, TokenUsage } from '@singula-ai/alego-llm'
import SessionStore, { Session, SessionId, SessionSeq, canonicalHeader } from '@singula-ai/alego-session'
import type { EpochHeader, SessionEvent, SessionSeq as SessionSeqType } from '@singula-ai/alego-session'
...
const SYSTEM_PLUGIN = '@singula-ai/alego-system-prompt'
