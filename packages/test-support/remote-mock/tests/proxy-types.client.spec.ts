...
import type { TypertRemoteNamespace, TypertRemoteNamespaceMap } from '@singula-ai/alego-typert-protocol'
import type {} from '@singula-ai/alego-api-settings-controller/remote'
...
describe('RemoteMock proxy types', { timeout: 60_000 }, () => {
  it('keeps production closed while an empty generated map permits Mock calls and overrides', () => {
    compile(`
import type { TypertRemoteNamespace, TypertClientRemote } from '@singula-ai/alego-typert-protocol'
...
`)
  ...
  it('preserves generated arguments, results and native spy overrides', () => {
    compile(`
import type { MockedRemote } from '../src/remote-proxy.ts'
import type {} from '@singula-ai/fixture/remote'
type IsAny<T> = 0 extends (1 & T) ? true : false
declare const local: MockedRemote
...
`, fixtureDeclaration)
  ...
  it('keeps partial and empty namespaces closed inside a non-empty map', () => {
    compile(`
import type { TypertClientRemote, TypertRemoteNamespace } from '@singula-ai/alego-typert-protocol'
import type { MockedRemote } from '../src/remote-proxy.ts'
import type {} from '@singula-ai/fixture/remote'
...
`, fixtureDeclaration)
  ...
  it('retains the native/generated type dependencies only in the proxy declaration', () => {
    ...
    expect(runtime.outputText).not.toContain('@singula-ai/alego-typert-protocol')
...
import type { TypertRemoteNamespace } from '@singula-ai/alego-typert-protocol'
