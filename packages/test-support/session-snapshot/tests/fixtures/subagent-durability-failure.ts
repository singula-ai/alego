...
import type { SubagentPromptRequestId } from '@singula-ai/alego-subagent'
 ...
 *  - Under `ALEGO_SNAPSHOT_HUMAN_STEER`, a browser-authored prompt steers the
...
export function apply(ctx: Context): void {
  ...
  const humanSteer = process.env.ALEGO_SNAPSHOT_HUMAN_STEER === '1'
