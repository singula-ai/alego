...
import type { Agent, AgentOptions, Inbox, InboxTarget } from '@singula-ai/alego-agent'
...
import type { SessionHeader, SessionId, UserMessage } from '@singula-ai/alego-session'
