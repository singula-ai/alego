/**
 * Package-owned invariant companion for `@singula-ai/alego-agent-loop-testkit`.
 * @module @singula-ai/alego-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-agent-loop-testkit'
