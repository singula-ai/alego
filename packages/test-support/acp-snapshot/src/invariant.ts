/**
 * Package-owned invariant companion for `@singula-ai/alego-acp-snapshot`.
 * @module @singula-ai/alego-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-acp-snapshot'
