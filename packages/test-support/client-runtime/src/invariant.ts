/**
 * Package-owned invariant companion for `@singula-ai/alego-client-test-runtime`.
 * @module @singula-ai/alego-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-test-runtime'
