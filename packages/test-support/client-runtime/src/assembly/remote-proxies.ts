 ...
 * @module @singula-ai/alego-client-test-runtime/src/assembly/remote-proxies
 */
import type { Context } from '@singula-ai/cordis'
import { cancelledFailure, carrierFailure } from '@singula-ai/alego-api-gateway/client'
...
export const REMOTES_PACKAGE = '@singula-ai/alego-api-remotes'
