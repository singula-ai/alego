 ...
 * @module @singula-ai/alego-client-test-runtime/src/assembly/modules
 */
import * as modulesClient from '@singula-ai/alego-client-modules/client'
import { createClientModuleSystem } from '@singula-ai/alego-client-modules/client'
import type { ClientModuleLoader, ClientModuleLoaderTarget, WebBootGraph } from '@singula-ai/alego-client-modules/client'
...
export const MODULES_PACKAGE = '@singula-ai/alego-client-modules'
 ...
 * statically imported `@singula-ai/alego-client-modules/client` namespace.
