...
import type { SessionRequestId } from '@singula-ai/alego-api-session-controller/types'
...
import type { ObservableSnapshot, SnapshotStore } from '@singula-ai/alego-client-store'
