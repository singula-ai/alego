...
const HMR = '@singula-ai/alego-client-hmr'
const MODULES = '@singula-ai/alego-client-modules'
const SESSIONS = '@singula-ai/alego-api-session-controller'
const FILE_UPLOAD = '@singula-ai/alego-client-file-upload'
