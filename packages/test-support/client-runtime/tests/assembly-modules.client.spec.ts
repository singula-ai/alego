...
import { parseBootManifest } from '@singula-ai/alego-client-modules/client'
import type { WebBootGraph } from '@singula-ai/alego-client-modules/client'
import * as uiRenderer from '@singula-ai/alego-client-ui-renderer/client'
import * as typertRegistry from '@singula-ai/alego-typert-registry/client'
...
const RENDERER = '@singula-ai/alego-client-ui-renderer'
const TYPERT = '@singula-ai/alego-typert-registry'
const BRAND = '@singula-ai/alego-client-ui-brand-official'
const MISSING = '@singula-ai/alego-client-does-not-exist'
...
describe('createInProcessModules', () => {
  it('serves import() and prefetch() from registered factories and never loads a bundle', async () => {
    ...
    await expect(system.import('@singula-ai/alego-client-unknown', '', {})).rejects.toThrow('cannot resolve')
  })
