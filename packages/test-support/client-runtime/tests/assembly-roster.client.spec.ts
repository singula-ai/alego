...
import { createClientModuleSystem, parseBootManifest, type ClientBundleRegistration, type ClientModuleLoaderTarget } from '@singula-ai/alego-client-modules/client'
...
describe('ClientRoster', () => {
  ...
  it('closure treats the platform seed modules as satisfied without a row', () => {
    const seeded = { name: 'seeded', inject: ['@singula-ai/alego-client-ui-primitives', 'react', 'a'], immediately: false }
