...
`pnpm --dir /path/to/alego run demo:acp` 启动仓库的自动化服务器组合。父 harness 可以通过 [`@singula-ai/alego-subagent-acp`](../../subagent/subagent-acp/README.zh.md) spawn 它；其他 ACP 客户端只需上述核心方法。
