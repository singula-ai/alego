...
import { installModelSelection, type ModelSelection, type ModelSelectionRef } from '@singula-ai/alego-agent'
import { ReasoningEffortId, type LlmCallConfig, type LlmRuntime } from '@singula-ai/alego-llm'

const MODEL_CONFIG_ID = 'model'
const REASONING_CONFIG_ID = 'reasoning_effort'
// ALEGO reasoning effort ids are non-empty, so the empty opaque ACP value is a disjoint provider-default choice.
