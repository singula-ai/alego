/** Standard ACP updates derived from committed ALEGO session events. */
 ...
 * @param event - committed ALEGO tool-call event.
 ...
 * @param event - committed ALEGO tool-result event.
...
/** Report current context occupancy only when ALEGO has both usage and capacity facts. */
