/** Standard ACP MCP-server declarations translated into Agent-scoped ALEGO MCP clients. */
...
/** Produce a stable ALEGO tool namespace from ACP's human-readable server name. */
