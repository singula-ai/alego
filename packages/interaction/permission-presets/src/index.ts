...
import { SANDBOX_MODES, setSandboxMode } from '@singula-ai/alego-sandbox-policy'
...
import { APPROVAL_POLICIES, setApprovalPolicy } from '@singula-ai/alego-user-approval'
