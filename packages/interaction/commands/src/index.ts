...
import type { EncodedImageAttachment, FileAttachmentRef, ImageAttachmentRef } from '@singula-ai/alego-attachment/types'
import type { FileBlock, ImageBlock } from '@singula-ai/alego-llm'
