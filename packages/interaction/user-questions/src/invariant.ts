/**
 * Package-owned invariant companion for `@singula-ai/alego-user-questions`.
 * @module @singula-ai/alego-user-questions/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-user-questions'
