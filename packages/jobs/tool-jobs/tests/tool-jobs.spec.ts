...
import AgentRegistry, { emitAgentEvent } from '@alego/agent'
...
import type { JobHooks, JobOutcome, JobSnapshot, JobStart } from '@alego/jobs'
import * as ToolTasks from '@alego/tool-jobs'
import { statusLine } from '@alego/tool-jobs'
