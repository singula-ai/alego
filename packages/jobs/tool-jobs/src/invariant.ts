/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-jobs`.
 * @module @singula-ai/alego-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-jobs'
