...
The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-tool-jobs) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#singula-aialego-tool-jobs) — the exact `job_output`, `job_list`, and `job_kill` schemas.
- [Generated configuration catalog](../../../docs/config-catalog.md#singula-aialego-tool-jobs) — every accepted config field and its source declaration.
