/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-skill`.
 * @module @singula-ai/alego-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-skill'
