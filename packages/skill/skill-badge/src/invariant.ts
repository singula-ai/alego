/**
 * Package-owned invariant companion for `@singula-ai/alego-skill-badge`.
 * @module @singula-ai/alego-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-skill-badge'
