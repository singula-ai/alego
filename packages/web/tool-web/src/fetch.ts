...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@singula-ai/alego-tools'
import type { WebFetchBody, WebFetchResult } from '@singula-ai/alego-web'
import { assertNever, type JsonValue } from '@singula-ai/alego-util-values'
