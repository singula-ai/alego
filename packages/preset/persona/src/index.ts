 ...
 *
 * `alego-system-prompt` owns the global persona as its own config, and registers
 ...
 * exactly like the per-child persona `alego-subagent` installs; mounted globally
 ...
 * @module @singula-ai/alego-persona
 */

import type { Context } from '@singula-ai/cordis'
import z from '@singula-ai/schemastery'
import type {} from '@singula-ai/alego-system-prompt'
import { PERSONA_PREFIX_SECTION, PERSONA_SUFFIX_SECTION } from '@singula-ai/alego-system-prompt'
