...
import { PERSONA_SUFFIX_SECTION, PERSONA_PREFIX_SECTION } from '@singula-ai/alego-persona'
...
describe('the persona row', () => {
  it('shadows and interpolates the environment per scope, restoring both defaults on disposal', async () => {
    ...
    try {
      ...
      expect(renderPrompt(assembly)).toBe('You are an AI agent powered by Alego.\n\nPreset.\n\nUse tools.\n\nWorkspace /local.')
