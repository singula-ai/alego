...
import AgentRegistry, { assembleContextFor } from '@alego/agent'
import AgentLoop from '@alego/agent-loop'
import InvariantRegistry from '@alego/invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@alego/agent-presets'
import * as AgentPresetsInvariant from '@alego/agent-presets/invariant'
