...
import AgentPresets, { livePresetMounts, type Config } from '@singula-ai/alego-agent-presets'
import * as AgentPresetsInvariant from '@singula-ai/alego-agent-presets/invariant'
