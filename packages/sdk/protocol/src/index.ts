 ...
 * (`@singula-ai/alego-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@singula-ai/alego-sdk-client`, the Python SDK) drive it.
 *
 * @module @singula-ai/alego-sdk-protocol
 */
