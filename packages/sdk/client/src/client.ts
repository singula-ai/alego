...
import { resolveAlegoLaunch, type RuntimeProcessOptions } from './launch.ts'
...
export class HarnessClient {
  /** Original public alego launch and timeout options for this client. */
  ...
  /** @param options - alego profile, patch, home, process, environment, and timeout options. */
  constructor(options?: HarnessClientOptions)
  constructor(options: HarnessClientOptions = {}, runtime?: RuntimeProcessOptions) {
    this.options = options
    this.runtime = runtime ?? resolveAlegoLaunch(options)
  }
