...
import type { StorageBackend } from '@singula-ai/alego-storage'
...
import { SessionPersistenceRevision } from '@singula-ai/alego-session-persistence'
...
async function makeDir(name: string): Promise<string> {
  base ??= await realpath(await mkdtemp(join(tmpdir(), 'alego-workspace-')))
