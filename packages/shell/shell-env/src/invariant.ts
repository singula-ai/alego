/**
 * Package-owned invariant companion for `@singula-ai/alego-shell-env`.
 * @module @singula-ai/alego-shell-env/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-shell-env'
