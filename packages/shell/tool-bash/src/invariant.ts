/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-bash`.
 * @module @singula-ai/alego-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-bash'
