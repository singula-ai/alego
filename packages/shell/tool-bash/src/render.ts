 ...
 *
 * @module @singula-ai/alego-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@singula-ai/alego-shell'
 ...
 * rendering story, owned by `@singula-ai/alego-shell` so `alego-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@singula-ai/alego-shell'
