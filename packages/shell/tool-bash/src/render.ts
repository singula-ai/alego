 ...
 *
 * @module @alego/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@alego/shell'
 ...
 * rendering story, owned by `@alego/shell` so `alego-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@alego/shell'
