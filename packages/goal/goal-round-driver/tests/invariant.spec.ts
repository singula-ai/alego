...
import * as GoalSessionInvariant from '@alego/goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@alego/goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@alego/goal-round-driver',
    }))
  })
