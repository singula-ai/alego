...
import * as GoalSessionInvariant from '@singula-ai/alego-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@singula-ai/alego-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@singula-ai/alego-goal-round-driver',
    }))
  })
