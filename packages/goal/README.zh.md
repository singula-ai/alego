...
- [生成的工具目录](../../docs/tool-catalog.zh.md#singula-aialego-tool-goal)——模型接收的三个 goal 工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#singula-aialego-goal)——goal 服务的每个受支持配置字段。
