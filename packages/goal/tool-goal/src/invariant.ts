/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-goal`.
 * @module @singula-ai/alego-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-goal'
