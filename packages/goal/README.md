...
- [Generated tool catalog](../../docs/tool-catalog.md#singula-aialego-tool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#singula-aialego-goal) — every accepted config field of the goal service.
