...
import AttachmentStore, { AttachmentError, AttachmentId } from '@singula-ai/alego-attachment'
...
import ToolRuntime, { type JsonValue } from '@singula-ai/alego-tools'
import type { PostToolDecision } from '@singula-ai/alego-tools'
import { publicToolName, syncTools, type ToolBridgeOptions } from '@singula-ai/alego-mcp-client/src/tools.ts'
import { createTransport } from '@singula-ai/alego-mcp-client/src/transport.ts'
