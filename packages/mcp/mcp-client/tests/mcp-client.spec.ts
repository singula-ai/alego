...
import AttachmentStore, { AttachmentError, AttachmentId } from '@alego/attachment'
...
import type { GenerateOptions, LlmResolvedModelInfo, StreamChunk } from '@alego/llm'
import SystemPrompt from '@alego/system-prompt'
import ToolRuntime, { type JsonValue } from '@alego/tools'
import type { PostToolDecision } from '@alego/tools'
import { publicToolName, syncTools, type ToolBridgeOptions } from '@alego/mcp-client/src/tools.ts'
import { createTransport } from '@alego/mcp-client/src/transport.ts'
