...
The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-session-title) is the exhaustive source for every accepted field and its JSDoc.
