...
import { createMessage, ToolCallId } from '@singula-ai/alego-llm'
import type { StreamChunk, TokenUsage } from '@singula-ai/alego-llm'
...
import { sessionStatsProjectionDefinition } from '@singula-ai/alego-session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@singula-ai/alego-session-stats/types'
