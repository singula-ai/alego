...
import { createMessage } from '@alego/llm'
...
import { sessionStatsProjectionDefinition } from '@alego/session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@alego/session-stats/types'
