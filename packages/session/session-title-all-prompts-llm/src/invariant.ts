/**
 * Package-owned invariant companion for `@alego/session-title-all-prompts-llm`.
 * @module @alego/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@alego/session-title-all-prompts-llm'
