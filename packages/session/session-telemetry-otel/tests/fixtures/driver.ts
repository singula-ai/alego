...
process.env.ALEGO_TELEMETRY_OTLP_URL = process.env.ALEGO_TELEMETRY_E2E_URL
process.env.ALEGO_TELEMETRY_MODE = process.env.ALEGO_TELEMETRY_E2E_MODE ?? 'FEEDBACK_ONLY'
...
try {
  ...
  try {
    ...
    if (process.env.ALEGO_TELEMETRY_E2E_FEEDBACK !== 'none') {
