/**
 * Package-owned invariant companion for `@singula-ai/alego-session-title-llm`.
 * @module @singula-ai/alego-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-title-llm'
