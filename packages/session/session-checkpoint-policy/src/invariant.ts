/**
 * Package-owned invariant companion for `@singula-ai/alego-session-checkpoint-policy`.
 * @module @singula-ai/alego-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-checkpoint-policy'
