/**
 * Package-owned invariant companion for `@alego/session-checkpoint-policy`.
 * @module @alego/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@alego/session-checkpoint-policy'
