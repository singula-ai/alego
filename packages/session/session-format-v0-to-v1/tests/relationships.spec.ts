...
import { SessionFormatUnsupportedMigrationError } from '@singula-ai/alego-session-format'
import {
  ...
  it('enforces title source cardinality and exact auxiliary framing', () => {
    ...
    expect(() => decode([...prefix, {
      ...
      data: {
        ...
        messages: [user('unrelated', { kind: 'plugin', plugin: 'alego-session-title-llm' })], maxTokens: 1,
      },
