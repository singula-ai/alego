/**
 * Package-owned invariant companion for `@singula-ai/alego-session-persistence-jsonl`.
 * @module @singula-ai/alego-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-persistence-jsonl'
