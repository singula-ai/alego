/**
 * Package-owned invariant companion for `@alego/session-persistence-jsonl`.
 * @module @alego/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@alego/session-persistence-jsonl'
