 ...
 * @module @singula-ai/alego-session-persistence-jsonl
 */
...
import { SESSION_FORMAT_VERSION, SessionId as makeSessionId, SessionLogOffset } from '@singula-ai/alego-session'
import type { SessionEvent, SessionId, SessionHeader, SessionLogOffset as SessionLogOffsetType } from '@singula-ai/alego-session'
import {
