/**
 * Package-owned invariant companion for `@singula-ai/alego-session-telemetry`.
 * @module @singula-ai/alego-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-telemetry'
