/**
 * Package-owned invariant companion for `@singula-ai/alego-session-projection`.
 * @module @singula-ai/alego-session-projection/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-projection'
