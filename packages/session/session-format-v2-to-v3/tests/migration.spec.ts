...
import { createSessionFormatCatalog, SessionFormatEventCollector } from '@singula-ai/alego-session-format'
...
import { releasedV0SessionFormatCodec, releasedV1SessionFormatCodec, sessionFormatV0ToV1 } from '@singula-ai/alego-session-format-v0-to-v1'
import { sessionFormatV1ToV2 } from '@singula-ai/alego-session-format-v1-to-v2'
