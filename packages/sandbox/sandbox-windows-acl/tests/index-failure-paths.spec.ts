...
import { ERROR_BROKEN_PIPE } from '@singula-ai/alego-win32-process/src/abi.ts'
import { PROCESS_INFORMATION } from '@singula-ai/alego-win32-process/src/ffi.ts'
...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), 'alego-acl-index-'))
