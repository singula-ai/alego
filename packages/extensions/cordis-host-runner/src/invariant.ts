/**
 * Package-owned invariant companion for `@singula-ai/alego-cordis-host-runner`.
 * @module @singula-ai/alego-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-cordis-host-runner'
