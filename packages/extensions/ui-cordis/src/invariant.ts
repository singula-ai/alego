/**
 * Package-owned invariant companion for `@singula-ai/alego-client-ui-cordis`.
 * @module @singula-ai/alego-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-client-ui-cordis'
