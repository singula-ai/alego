/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-cordis`.
 * @module @singula-ai/alego-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-cordis'
