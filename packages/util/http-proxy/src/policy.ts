 ...
 * evaluates `alego-web-fetch-http` without a Node transport.
 * @module @singula-ai/alego-http-proxy/policy
 */
 ...
 *
 * This is the single answer both the installed dispatcher and `alego-web-fetch-http` consult, so a URL
