/**
 * Package-owned invariant companion for `@singula-ai/alego-home-paths`.
 * @module @singula-ai/alego-home-paths/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-home-paths'
