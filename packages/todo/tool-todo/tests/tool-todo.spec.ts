...
import { Session, SessionId, SessionLogOffset } from '@singula-ai/alego-session'
...
/**
 * Drives the REAL plugin body: mounts `alego-tool-todo` on a real `ToolRuntime`
