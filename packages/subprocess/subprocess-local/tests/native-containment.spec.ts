...
import type { SubprocessSpawnSpec, SubprocessTerminalHandle } from '@singula-ai/alego-subprocess'
...
const scratch = mkdtempSync(join(tmpdir(), 'alego-native-containment-'))
