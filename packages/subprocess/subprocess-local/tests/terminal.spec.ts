...
import { createProcessInspector } from '@singula-ai/alego-subprocess-local/src/process-inspector.ts'
import type {
  ProcessIdentity,
  ProcessInspector,
...
import type { BoundProcessOwner } from '@singula-ai/alego-subprocess-local/src/managed-owner.ts'
