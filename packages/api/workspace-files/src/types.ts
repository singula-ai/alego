 ...
 *   resource system, whose `alego-resource://file/session/<id>/<path>` address carries that
 *   same path.
 ...
 *
 * @module @singula-ai/alego-api-workspace-files/types
 */
...
import type {} from '@singula-ai/alego-typert-protocol'
...
export interface WorkspaceFileStat {
   ...
   * on Windows. What an `alego-resource://file/absolute/…` address carries, and
   * what an `alego-resource://file/session/<sessionId>/…` address's
