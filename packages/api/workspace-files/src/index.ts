...
import type { FsDirEntry, FsInfo, FsPathInfo, FsTarget } from '@singula-ai/alego-fs'
...
import { Remote, RemoteError, TypertRemoteService, type TypertLookup } from '@singula-ai/alego-typert-protocol'
  ...
  constructor(ctx: Context, private readonly config: Config) {
    ...
    ctx.inject(['sessions', 'typert'], (scope) => {
      scope.typert.lookups.register('workspaceFileScope', {
        ...
        hostTypeSymbol: '@singula-ai/alego-api-workspace-files#WorkspaceFileScope',
 ...
 * belongs to whichever `alego-fs` instance the provider loaded, so no class
