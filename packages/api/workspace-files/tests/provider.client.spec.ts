...
import type { RemoteFailure } from '@singula-ai/alego-typert-protocol'
...
describe('file provider — the address', () => {
  it.each([
    ['another scope', 'alego-resource://file/shared/x/w/a.txt'],
    ['no path', 'alego-resource://file/session/s1'],
    ['an absolute address with no path', 'alego-resource://file/absolute/'],
    ['another resource type', 'alego-resource://terminal/session/s1/1'],
