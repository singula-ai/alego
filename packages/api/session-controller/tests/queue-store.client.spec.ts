...
import type { MessageId, RpcId, SessionId } from '@singula-ai/alego-api-remotes/client'
import type { SessionControlFrame } from '@singula-ai/alego-api-session-controller/types'
