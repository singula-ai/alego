 ...
 */
import { AttachmentId, type FileAttachmentRef, type ImageAttachmentRef } from '@singula-ai/alego-attachment'
import type { ContentBlock } from '@singula-ai/alego-llm/types'
import type { MessageId } from '@singula-ai/alego-llm/brand'
import { ok, type RemoteMock, type RemoteTable, type StreamScript, type UnaryRuleFn } from '@singula-ai/alego-remote-mock'
