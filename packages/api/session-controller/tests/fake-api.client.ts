...
import type { WorkspaceRemote } from '@singula-ai/alego-api-workspace-controller/client'
import type { WorkspaceFollowFrame } from '@singula-ai/alego-api-workspace-controller/types'
import type { RemoteFailure, RemoteResult } from '@singula-ai/alego-typert-protocol'
import {
  RemoteStream,
  type RemoteStreamOptions,
} from '@singula-ai/alego-api-gateway/client'
import type { SessionRemotes } from '../src/client/sessions/remotes.ts'
import { SESSION_FORMAT_VERSION } from '@singula-ai/alego-session/types'
