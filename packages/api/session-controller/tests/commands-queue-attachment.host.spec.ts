...
import type { Agent, Inbox, ModelSelectionRef } from '@singula-ai/alego-agent'
...
import { createAssistantMessage, createUserMessage, MessageId } from '@singula-ai/alego-llm'
import SessionStore, {
  SESSION_FORMAT_VERSION, Session, SessionId, SessionLogOffset, SessionSeq,
} from '@singula-ai/alego-session'
import type { SessionEvent, SessionHeader, UserMessage } from '@singula-ai/alego-session'
import { snapshotSubagentDescriptor, SUBAGENT_DESCRIPTOR_VERSION } from '@singula-ai/alego-subagent'
import { subagentIdentityProjectionDefinition } from '@singula-ai/alego-subagent/src/projection.ts'
