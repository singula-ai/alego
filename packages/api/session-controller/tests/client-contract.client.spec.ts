...
import type { PromptContentPart as AttachmentPromptContentPart } from '@singula-ai/alego-attachment/types'
import { SessionSeq, type SessionSeqCursor } from '@singula-ai/alego-session/types'
import {
