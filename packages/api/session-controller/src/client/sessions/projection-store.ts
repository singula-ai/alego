...
import type { SessionSeqCursor } from '@singula-ai/alego-session/types'
...
// (`/types`, zero imports), never the package root: the root's alego-agent →
// alego-session chain would drag the host `Context.sessions` merge into the
