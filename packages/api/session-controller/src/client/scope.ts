 ...
 * Agent's identity. The mechanism mirrors the host `alego-scope` architecture
...
import type { TypertRemoteScopeApi } from '@singula-ai/alego-typert-protocol'
...
const kScope = Symbol('alego.client.scope')
