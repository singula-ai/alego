...
import { RemoteStreamCarrierError, type ClientRemote } from '@singula-ai/alego-api-gateway/client'
import { SessionId } from '@singula-ai/alego-session/types'
import { RemoteError } from '@singula-ai/alego-typert-protocol'
import { frames, openStream, type RemoteMock, type StreamScript } from '@singula-ai/alego-remote-mock'
...
const SELF = '@singula-ai/alego-api-workspace-controller'
