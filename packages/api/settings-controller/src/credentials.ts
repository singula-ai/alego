 ...
 *
 * @module @singula-ai/alego-api-settings-controller/src/credentials.ts
 */

import { Context } from '@singula-ai/cordis'
import { credentialRef } from '@singula-ai/alego-credentials'
import type { CredentialProvider } from '@singula-ai/alego-credentials'
import type { CredentialInfo } from '@singula-ai/alego-credentials/types'
import { Remote, RemoteError, TypertRemoteService } from '@singula-ai/alego-typert-protocol'
import { z } from 'zod'
  ...
  private provider(): CredentialProvider {
    ...
    if (credentials === undefined) {
      throw new RemoteError(
        'gateway/internal',
        'credentials service is absent: this deployment does not mount a credential provider (e.g. @singula-ai/alego-credentials-local) in its composition',
        {},
      )
    }
    return credentials
