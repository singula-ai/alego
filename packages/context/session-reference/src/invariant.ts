/**
 * Package-owned invariant companion for `@singula-ai/alego-session-reference`.
 * @module @singula-ai/alego-session-reference/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-session-reference'
