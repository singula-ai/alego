...
The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-session-reference) is the exhaustive source for every accepted field and its JSDoc.
...
| [`src/uri.ts`](src/uri.ts) | `alego-session:` URI codec, mention formatting and parsing |
...
- [Generated configuration catalog](../../../docs/config-catalog.md#singula-aialego-session-reference) — every accepted config field and its source declaration.
