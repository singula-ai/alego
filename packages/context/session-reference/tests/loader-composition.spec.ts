...
import * as systemPromptPlugin from '@singula-ai/alego-system-prompt'
import * as toolsPlugin from '@singula-ai/alego-tools'
import * as fsPlugin from '@singula-ai/alego-fs-local'
import * as toolFsPlugin from '@singula-ai/alego-tool-fs'
import * as sessionPlugin from '@singula-ai/alego-session'
import { Session, SessionId } from '@singula-ai/alego-session'
import * as queryPlugin from '@singula-ai/alego-session-query-sqlite'
import * as referencePlugin from '@singula-ai/alego-session-reference'
import * as spillPlugin from '@singula-ai/alego-spill-local'
import { sessionDir } from '@singula-ai/alego-spill-local'
...
describe('session-reference real Loader composition', () => {
  it('logs a bounded preview and reads the full immutable spill owned by the target', async () => {
    ...
    const modules = new Map<string, unknown>([
      ['@singula-ai/alego-session', sessionPlugin],
      ['@singula-ai/alego-system-prompt', systemPromptPlugin],
      ['@singula-ai/alego-tools', toolsPlugin],
      ['@singula-ai/alego-fs-local', fsPlugin],
      ['@singula-ai/alego-tool-fs', toolFsPlugin],
      ['@singula-ai/alego-session-query-sqlite', queryPlugin],
      ['@singula-ai/alego-session-reference', referencePlugin],
      ['@singula-ai/alego-spill-local', spillPlugin],
