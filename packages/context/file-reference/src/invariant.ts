/**
 * Package-owned invariant companion for `@singula-ai/alego-file-reference`.
 * @module @singula-ai/alego-file-reference/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-file-reference'
