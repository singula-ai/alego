...
| `alegoHome` | `$ALEGO_HOME` or `~/.alego` | Directory containing the user-global `AGENTS.md` |

The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-agent-instructions) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#singula-aialego-agent-instructions) — every accepted config field and its source declaration.
