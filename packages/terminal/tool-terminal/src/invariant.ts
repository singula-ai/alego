/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-terminal`.
 * @module @singula-ai/alego-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-terminal'
