/**
 * Package-owned invariant companion for `@singula-ai/alego-terminal-bash`.
 * @module @singula-ai/alego-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-terminal-bash'
