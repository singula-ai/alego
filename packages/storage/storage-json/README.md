...
The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-storage-json) is the exhaustive source for every accepted field and its JSDoc.
