/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-session-query`.
 * @module @singula-ai/alego-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-session-query'
