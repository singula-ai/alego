/**
 * Package-owned invariant companion for `@alego/session-query-sqlite`.
 * @module @alego/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@alego/session-query-sqlite'
