/**
 * Package-owned invariant companion for `@singula-ai/alego-sdk-jsonrpc-demo`.
 * @module @singula-ai/alego-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-sdk-jsonrpc-demo'
