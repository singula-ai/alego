...
import { createSystemMessage, createUserMessage, ToolCallId, createMessage, createToolResultMessage, MessageId, ReasoningEffortId } from '@singula-ai/alego-llm'
import SessionStore, {
  adoptSessionEvent,
...
import type { CreateSessionOptions, SessionEventType, SessionHeader, SessionSurface } from '@singula-ai/alego-session'
  ...
  it('adopts a system/message by freezing its message', () => {
    const event = {
      ...
      data: {
        turn: 1,
        step: 1,
        message: createSystemMessage('You are terse.', '@singula-ai/alego-system-prompt'),
      },
    } as unknown as SessionEvent
