...
import SessionStore, { SessionId, SessionPreparation } from '@singula-ai/alego-session'
...
import AgentLoop, { CONFIGURED_AGENT_IDENTITIES_KEY } from '@singula-ai/alego-agent-loop'
