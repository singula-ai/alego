import { ToolCallId, createUserMessage, expandAssistantStream } from '@singula-ai/alego-llm'
/**
 ...
 * @module alego-agent-loop/tests/cancel
 */

import { describe, expect, it } from 'vitest'
import { Context } from '@singula-ai/cordis'
import LlmRuntime from '@singula-ai/alego-llm'
import SessionStore, { Session, SessionId, SessionLogOffset, TurnEndReason } from '@singula-ai/alego-session'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // alego-llm-retry opens when its backoff waits after appending llm/retry.
