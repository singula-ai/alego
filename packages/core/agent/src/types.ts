...
import type { OptionalSessionSeq, SessionId, SessionSeq } from '@singula-ai/alego-session/types'
 ...
 *
 * Reader contract: the key is registered by `alego-agent-loop` and absent
