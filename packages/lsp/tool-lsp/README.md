...
The generated [configuration catalog](../../../docs/config-catalog.md#singula-aialego-tool-lsp) is the exhaustive source for every accepted field.
...
- [alego-lsp](../lsp/README.md) — the seam this tool queries.
- [alego-lsp-stdio](../lsp-stdio/README.md) — the stdio provider that answers these queries.
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#singula-aialego-tool-lsp).
