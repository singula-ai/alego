...
import Lsp, { type LspProvider, type LspQueryRequest, type LspQueryResult } from '@singula-ai/alego-lsp'
...
import type { LspLocalServerConfig } from '@singula-ai/alego-lsp-stdio'
