/**
 * Package-owned invariant companion for `@singula-ai/alego-anonymous-user-id`.
 * @module @singula-ai/alego-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-anonymous-user-id'
