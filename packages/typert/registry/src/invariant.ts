/**
 * Package-owned invariant companion for `@singula-ai/alego-typert-registry`.
 * @module @singula-ai/alego-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-typert-registry'
