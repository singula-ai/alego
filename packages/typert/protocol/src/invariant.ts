/**
 * Package-owned invariant companion for `@singula-ai/alego-typert-protocol`.
 * @module @singula-ai/alego-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-typert-protocol'
