...
import type { DirectoryPickerCapability } from '@singula-ai/alego-host-directory-picker'
import WorkspaceRegistry from '@singula-ai/alego-workspace'
import type { HostFrame, WorkspaceId } from '@singula-ai/alego-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@singula-ai/alego-host-apiproxy/api/rpc'
