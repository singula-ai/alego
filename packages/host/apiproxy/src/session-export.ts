...
import type { SessionId, SessionStore } from '@singula-ai/alego-session'
import type { SessionPersistence, SessionRawArtifact } from '@singula-ai/alego-session-persistence'
