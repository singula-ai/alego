/** Package-owned invariant companion for the directory-picker seam. @module @singula-ai/alego-host-directory-picker/invariant */

import type { Context } from '@singula-ai/cordis'
import type { InvariantInstaller } from '@singula-ai/alego-invariants'

const PACKAGE_NAME = '@singula-ai/alego-host-directory-picker'
