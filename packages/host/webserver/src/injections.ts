...
/**
 * Tail script settling the boot-readiness deferred (`__ALEGO_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__ALEGO_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
