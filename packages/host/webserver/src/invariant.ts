/**
 * Package-owned invariant companion for `@singula-ai/alego-host-webserver`.
 * @module @singula-ai/alego-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-host-webserver'
