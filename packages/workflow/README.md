...
- [Generated tool catalog](../../docs/tool-catalog.md#singula-aialego-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#singula-aialego-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#singula-aialego-workflow-worker-thread) — every accepted engine config field.
