 ...
 * @module @singula-ai/alego-workflow-worker-thread/protocol
 */

import type { WorkflowAgentEndInfo, WorkflowAgentInfo, WorkflowResult } from '@singula-ai/alego-workflow'
