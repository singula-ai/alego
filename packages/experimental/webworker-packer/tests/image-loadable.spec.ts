...
import { createNodeBuiltins, REPLACED_PREFIXES } from '@singula-ai/alego-experimental-webworker-runtime/src/node/builtins.ts'
import {
  setActiveModuleLoader, WorkerModuleLoader,
} from '@singula-ai/alego-experimental-webworker-runtime/src/module-system/module-loader.ts'
import { inflateImage } from '@singula-ai/alego-experimental-webworker-runtime/src/storage/image-gzip.ts'
import { loadVfsImage } from '@singula-ai/alego-experimental-webworker-runtime/src/storage/memory.ts'
...
const SUBJECT = '@singula-ai/alego-timeout'
const LANDLOCK = '@singula-ai/node-addon-landlock-run'
const PLUGIN_INVENTORY = '@singula-ai/alego-plugin-package-inventory-deepseek'
const WEB_SERVER = '@singula-ai/alego-host-webserver'
