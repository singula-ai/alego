    ...
    switch (method) {
      ...
      case 'Network.getResponseBody': {
        ...
        return {
          ...
          base64Encoded: true,
          alegoInspectorTruncated: body.truncated,
          ...(body.captureError === undefined ? {} : { alegoInspectorCaptureError: body.captureError }),
        }
      }
    ...
    switch (event.type) {
      ...
      case 'response-received': {
        ...
        session.sendEvent('Network.responseReceived', {
          ...
          loaderId: 'alego-inspector-loader',
          frameId: 'alego-inspector-host-frame',
          timestamp,
          type: resourceType,
          response: {
            url: event.url,
      ...
      case 'request-finished':
        ...
        session.sendEvent('Network.loadingFinished', {
          ...
          alegoInspectorTruncated: event.truncated,
        })
