...
const CLIENT_SOURCE_STORAGE_KEY = 'alego.experimental-inspector.client-source-id.v0'
const CLIENT_SOURCE_LOCK_PREFIX = 'alego.experimental-inspector.client-source:'
