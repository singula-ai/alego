...
describe.skipIf(!requiredArtifacts)('Agent Teams built LIB service', () => {
  it('loads the Host service and its generated browser contribution under plain Node', async () => {
    ...
    expect(output).toEqual({
      ...
      methods: [
        '@singula-ai/alego-experimental-agent-team#agentTeams/createTask',
        '@singula-ai/alego-experimental-agent-team#agentTeams/updateTask',
        '@singula-ai/alego-experimental-agent-team#agentTeams/view',
      ],
    })
  })
})
