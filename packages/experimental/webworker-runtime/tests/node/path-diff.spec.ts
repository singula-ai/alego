...
import * as shim from '@singula-ai/alego-experimental-webworker-runtime/src/node/builtin_modules/implemented/path.ts'

const CASES = [
  '', '.', '..', '/', '//', '///', 'a', '/a', 'a/', '/a/', 'a/b', '/a/b/c', 'a//b', '/a//b/',
  './a', '../a', 'a/./b', 'a/../b', '/a/../..', '/../a', 'a/b/../../c', '.hidden', 'a.b.c',
  '/a/b/c.txt', 'c.txt', '.txt', 'a/.txt', 'a/b.', '/a/b/.', '/a/b/..', 'foo/bar/../baz/./qux',
  '/alego/node_modules/@singula-ai/alego-session/lib/index.js', 'node_modules/.bin/x',
]

const JOINS: string[][] = [
  ['a', 'b'], ['/a', 'b'], ['a', '/b'], ['a', '..'], ['a', '../..'], ['', 'b'], ['a', ''],
  ['/alego', 'config', 'cordis.yml'], ['/alego/node_modules', '@scope/pkg', 'lib/index.js'],
  ['a/', '/b'], ['.', 'a'], ['..', 'a'], ['/', 'a'], [],
]

const RESOLVES: string[][] = [
  ['a'], ['/a', 'b'], ['/a', '/b'], ['a', '..'], ['/alego', './config/../config/cordis.yml'],
  ['/a/b', '../c'], ['/'], ['', 'a'], ['/alego/node_modules/pkg', './lib/../lib/index.js'],
]

const RELATIVES: [string, string][] = [
  ['/a/b', '/a/b/c'], ['/a/b/c', '/a/b'], ['/a', '/b'], ['/a/b', '/a/b'], ['/', '/a'],
  ['/alego/node_modules/a', '/alego/node_modules/b/lib/x.js'],
]
