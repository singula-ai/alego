...
import { runShellCommand } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/interpret.ts'
import { filesystemError } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@singula-ai/alego-experimental-webworker-runtime/src/shell/types.ts'
