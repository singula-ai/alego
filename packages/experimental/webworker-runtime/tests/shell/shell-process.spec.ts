...
import { startProcess } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/process/host.ts'
import { runShellProcess } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/process/child.ts'
import { isShellStartFrame } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/process/protocol.ts'
import type { FromProcessFrame, ToProcessFrame } from '@singula-ai/alego-experimental-webworker-runtime/src/shell/process/protocol.ts'

const WORKSPACE = '/alego/workspace'
