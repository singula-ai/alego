 ...
 * @module @singula-ai/alego-experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like alego-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/alego', vfs = new MemoryVfs()): MemoryVfs {
