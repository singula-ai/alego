 ...
 * @module @singula-ai/alego-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { ALEGO_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? ALEGO_ROOT
