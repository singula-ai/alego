...
export const DEFAULT_ROOT = '/alego'
...
/** Home directory under the root; the process shim's `ALEGO_HOME`/`HOME` default. */
 ...
 */
export const LOWERING_VERSION = 'alego-worker-transform/1'
