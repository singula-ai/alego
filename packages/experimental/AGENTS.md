...
- Every package here uses the `@singula-ai/alego-experimental-*` npm prefix, sets `private: true`, and omits `publishConfig`; the workspace constraints gate enforces these declarations and the alego release family excludes this directory.
