...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@singula-ai/alego-experimental-agent-team/client'
import type {} from '@singula-ai/alego-experimental-agent-team/remote'
import { RemoteError } from '@singula-ai/alego-client-test-runtime'
import type { TypertRemoteContribution } from '@singula-ai/alego-typert-protocol'
...
const REMOTE: TypertRemoteContribution = {
  package: '@singula-ai/alego-experimental-agent-team',
  descriptors: [],
}
