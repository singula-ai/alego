...
```sh
pnpm alego plugin --profile web add ./packages/experimental/agent-team-profile
pnpm alego plugin --profile web add ./packages/experimental/agent-team-web-profile
```
