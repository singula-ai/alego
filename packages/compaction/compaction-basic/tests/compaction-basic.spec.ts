...
import { frameSummary } from '@singula-ai/alego-compaction-basic/src/summarizer.ts'
...
import LlmRuntime, { createUserMessage, ToolCallId, CONTEXT_WINDOW_EXCEEDED_CODE, createSystemMessage, createToolResultMessage, LlmAdapter , createMessage } from '@singula-ai/alego-llm'
import type {
  ContentBlock,
  GenerateOptions,
  LlmFailure,
...
const SYSTEM_PROMPT_PLUGIN = '@singula-ai/alego-system-prompt'
