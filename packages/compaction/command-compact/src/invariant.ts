/**
 * Package-owned invariant companion for `@singula-ai/alego-command-compact`.
 * @module @singula-ai/alego-command-compact/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-command-compact'
