 ...
 * `@singula-ai/alego-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @singula-ai/alego-tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@singula-ai/alego-subagent/internal'
