/**
 * Package-owned invariant companion for `@alego/tool-subagent-control`.
 * @module @alego/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@alego/tool-subagent-control'
