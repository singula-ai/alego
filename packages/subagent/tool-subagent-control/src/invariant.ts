/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-subagent-control`.
 * @module @singula-ai/alego-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-subagent-control'
