...
import { Session, SESSION_FORMAT_VERSION, SessionId } from '@singula-ai/alego-session'
import type { SessionEvent } from '@singula-ai/alego-session'
import { bindScopeParent, createScope, scopeOf, scopeTarget } from '@singula-ai/alego-scope'
...
describe('SubagentModelSelectionConfig', () => {
  ...
  it('requires both the Host setting owner and a scoped standing preset', async () => {
    ...
    }).toThrow('requires @singula-ai/alego-tool-subagent/model-selection-settings')
