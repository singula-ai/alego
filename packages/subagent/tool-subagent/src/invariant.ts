/**
 * Package-owned invariant companion for `@singula-ai/alego-tool-subagent`.
 * @module @singula-ai/alego-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@singula-ai/alego-tool-subagent'
