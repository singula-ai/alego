/**
 * Package-owned invariant companion for `@alego/tool-subagent-report`.
 * @module @alego/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@alego/tool-subagent-report'
