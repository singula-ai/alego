...
- [Generated configuration catalog](../../../docs/config-catalog.md#singula-aialego-subagent-claude-code) — every accepted config field and its source declaration.
