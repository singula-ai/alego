 ...
 * `alego-subagent-acp` tests. It speaks the agent side of ACP over stdio and is
 ...
 *
 * @module @singula-ai/alego-subagent-acp/tests/mock-acp-server
 */
...
createAcpAgentApp({ name: 'alego-subagent-acp-test-agent' })
