 ...
 *
 * @module @singula-ai/alego-subagent/catalog
 */

import { z } from 'zod'
import { appendChunkedList, chunkedListSchema, iterateChunkedList } from '@singula-ai/alego-chunked-list'
import type { ChunkedList } from '@singula-ai/alego-chunked-list'
import type {
  Session,
  SessionEvent,
  SessionHeader,
