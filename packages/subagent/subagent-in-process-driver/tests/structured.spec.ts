...
import { createUserMessage, ToolCallId, type ContentBlock, type GenerateOptions } from '@singula-ai/alego-llm'
...
import type { Config as ToolConfig, ObjectJsonSchema } from '@singula-ai/alego-tools'
import { defineContentToolFixture, RUN_CODE_NAME } from '@singula-ai/alego-tools'
