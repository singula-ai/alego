import { createUserMessage, type GenerateOptions } from '@singula-ai/alego-llm'
import { describe, expect, it } from 'vitest'
import { Context, symbols, type EffectMeta } from '@singula-ai/cordis'
...
describe('alego-subagent-spawn-in-process', () => {
