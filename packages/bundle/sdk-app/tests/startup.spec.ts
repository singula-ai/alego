...
import { internals, provideCmdline } from '@singula-ai/alego-cmdline'
...
describe('SDK app startup', () => {
  ...
  it('prints app help without publishing readiness or binding stdin', () => {
    ...
    expect(out()).toContain('alego --profile sdk')
  ...
  it('renders the selected SDK profile name in help', () => {
    ...
    expect(out()).toContain('Usage: alego --profile sdk-minimal')
    expect(out()).toContain('alego --profile sdk-minimal')
  })
})
