...
async function main(args: string[]): Promise<number> {
  ...
  const failFast = flagEnabled('ALEGO_GATE_FAIL_FAST')
 ...
 * @param failFast - whether `ALEGO_GATE_FAIL_FAST` is enabled.
...
// ALEGO_COVERAGE_TEST_TIMEOUT_MS raises Vitest's per-test, expect.poll, and hook
