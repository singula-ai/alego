...
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@singula-ai/alego-attachment'
...
import * as WebFetchLocal from '@singula-ai/alego-web-fetch-http'
import SubagentRuntime from '@singula-ai/alego-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@singula-ai/alego-subagent'
import * as ToolSubagentControl from '@singula-ai/alego-tool-subagent-control'
import * as ToolSubagentListAgents from '@singula-ai/alego-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@singula-ai/alego-tool-subagent-report'
...
import CordisHostRunner from '@singula-ai/alego-cordis-host-runner'
import * as ToolCordis from '@singula-ai/alego-tool-cordis'
...
import * as ToolSchedule from '@singula-ai/alego-schedule'
import Lsp from '@singula-ai/alego-lsp'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@singula-ai/alego-plan-mode',
    dir: 'plan-mode',
  ...
  },
  {
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@singula-ai/alego-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `ALEGO_*` environment comes from `@singula-ai/alego-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
  ...
  {
    pkg: '@singula-ai/alego-tool-pwsh-persistent',
  ...
  {
    pkg: '@singula-ai/alego-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@singula-ai/alego-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@singula-ai/alego-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@singula-ai/alego-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@singula-ai/alego-tool-goal',
    dir: 'tool-goal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@singula-ai/alego-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@singula-ai/alego-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@singula-ai/alego-tool-skill',
    dir: 'tool-skill',
  ...
  {
    pkg: '@singula-ai/alego-tool-session-query',
  ...
  {
    pkg: '@singula-ai/alego-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@singula-ai/alego-tool-subagent-control',
  ...
  {
    pkg: '@singula-ai/alego-tool-subagent-report',
  ...
  {
    pkg: '@singula-ai/alego-tool-jobs',
    dir: 'tool-jobs',
  ...
  {
    pkg: '@singula-ai/alego-experimental-tool-agent-team',
    dir: 'tool-agent-team',
  ...
  {
    pkg: '@singula-ai/alego-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@singula-ai/alego-tool-workflow',
    dir: 'tool-workflow',
