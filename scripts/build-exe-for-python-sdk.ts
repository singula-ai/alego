/**
 * Build the alego executables and development Node carrier for the Python runtime wheel. The fixed
...
const DEPLOY_ROOT_PACKAGE = 'alego-python-runtime-closure'
/** The sole application launcher inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@singula-ai/alego/lib/bin.js'
/** Python-visible executable basename. */
const OUTPUT_BASENAME = 'alego-sdk-runtime'
/** Default Node major; SEA mode requires at least Node 22. */
const DEFAULT_NODE_RANGE = 'node24'
const OUT_DIR = 'dist-exe'
/** Python package destination; created when absent. */
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/alego_runtime/runtime'
...
const ASSET_GLOBS = [
  ...
  'node_modules/@singula-ai/alego-web-frontend/dist/**/*',
  // skill-badge resolves both Markdown and image resources through import.meta.url.
  'node_modules/@singula-ai/alego-skill-badge/assets/**/*',
]
