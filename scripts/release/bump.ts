...
/** One private alego workspace whose version follows the publishable family. */
...
/**
 * Discover private package and application manifests that share the alego version
