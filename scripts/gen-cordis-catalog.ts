...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@singula-ai/alego-typert-generator'
import type { CordisCatalogPolicy } from '@singula-ai/alego-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@singula-ai/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  alegoHomePath: 'not a service: boot-provided root accessor function (typeof alegoHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@singula-ai/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AlegoEnvironment: 'subprocess.md',
