...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@alego/typert-generator'
import type { CordisCatalogPolicy } from '@alego/typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@alego/cordis'`
 ...
 * scan reads EVERY `declare module '@alego/cordis'` Events merge under
