...
describe('Python runtime executable assets', () => {
  it('packages the dynamically resolved web frontend distribution', () => {
    ...
    expect(result.stdout).toContain('node_modules/@singula-ai/alego-web-frontend/dist/**/*')
    expect(result.stdout).toContain('node_modules/@singula-ai/alego-skill-badge/assets/**/*')
