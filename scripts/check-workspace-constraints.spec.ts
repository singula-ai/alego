...
describe('experimental workspace constraints', () => {
  ...
  it('requires public metadata only for the Agent Teams exceptions', () => {
    ...
    expect(checkExperimentalManifest({
      ...
      '@singula-ai/alego-experimental-agent-team: public experimental package must not set "private": true',
      '@singula-ai/alego-experimental-agent-team: public experimental package must set publishConfig.access to "public"',
    ])
  })
