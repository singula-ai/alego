...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [alego-doc-standards](../alego-doc-standards/SKILL.md) when deciding where content belongs or changing product documentation prose.
...
Use [alego-pre-push-checks](../alego-pre-push-checks/SKILL.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.
