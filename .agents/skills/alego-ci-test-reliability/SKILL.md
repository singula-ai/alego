...
- Use [alego-pre-push-checks](../alego-pre-push-checks/SKILL.md) after the test design is sound to select outgoing validation.
...
Before a push, use [alego-pre-push-checks](../alego-pre-push-checks/SKILL.md). Report exact commands and observed results; do not describe retries, skipped tests, or pending CI as passing.
