...
- Each catalog consumer owns its selection interaction. ACP uses standard session configuration options and emits no ALEGO-specific selector or UI metadata.
