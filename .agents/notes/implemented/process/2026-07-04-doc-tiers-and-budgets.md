...
- **A thin workflow skill, contracts in docs.** [.agents/skills/alego-doc-standards](../../../skills/alego-doc-standards/SKILL.md) carries the placement/audit/red-gate workflow and defers to the standard as its source of truth, the same split as [alego-translate-docs](../../../skills/alego-translate-docs/SKILL.md) over the i18n contract.
