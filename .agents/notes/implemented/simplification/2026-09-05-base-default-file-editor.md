...
This refines the shared tool defaults in [one alego launcher](../architecture/2026-08-22-single-alego-application-launcher.md). That note remains active for launch ownership, shared services, and patch precedence; no active note is fully superseded.
