# Agent Note: Omit runtime invariants from shipped alego config
...
- Ordinary `alego` TUI and Web runs install no invariant listeners or trace state and cannot fail through `InvariantError`.
