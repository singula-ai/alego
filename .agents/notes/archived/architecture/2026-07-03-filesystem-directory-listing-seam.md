...
**Keep directory enumeration in each consumer.** Rejected. That would bind product packages such as `alego-skill` to Node/local filesystem behavior and bypass policy/remote/sandboxed backends.
