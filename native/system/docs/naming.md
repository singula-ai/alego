...
The public package family belongs to the `@singula-ai` scope and uses the `node-addon-system` package prefix; platform packages append platform information only:

```text
@singula-ai/node-addon-system
@singula-ai/node-addon-system-<platform>
```
