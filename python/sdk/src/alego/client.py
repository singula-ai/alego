...
class HarnessClient:
    ...
    def _default_launch_args(self) -> tuple[str, ...]:
        ...
        try:
            ...
            raise FileNotFoundError(
                "Unable to locate the bundled Alego SDK runtime. "
                "Install alego-runtime-bin or set HarnessConfig.runtime_bin."
            ) from exc
    ...
    def _inject_bundled_default_config(self, env: dict[str, str]) -> None:
        ...
        if not uses_bundled_runtime or env.get("ALEGO_CORDIS_CONFIG"):
            return
        # _default_launch_args already imported the package or raised its install error.
        from alego_runtime import bundled_default_config_path

        env["ALEGO_CORDIS_CONFIG"] = str(bundled_default_config_path())
